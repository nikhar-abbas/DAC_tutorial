...
fast_output_file = [os.path.join(os.path.dirname(os.path.realpath(__file__)), 'BAR_00', 'OpenFAST_BAR_00.outb'),
                    os.path.join(os.path.dirname(os.path.realpath(__file__)), 'BAR_00_dac', 'BAR_00_dac_powercurve_0.outb')]

fast_out = fio.load_FAST_out(fast_output_file, tmin=50)
